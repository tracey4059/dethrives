<?php
/*
Template Name: Circle Style with Sidebar
*/
get_header();
?>
<style>
#circle-s h2 {color: #<?php the_field('page_color'); ?>;}
#circle-s button {background-color: #<?php the_field('page_color'); ?> !important;}
#circle-s a {color: #<?php the_field('page_color'); ?>;}
</style>
...
<div class="row">
  ...
  <div class="large-8 medium-12 small-12 columns mbottom hideme"> 
    ...
    <div id="primary" class="content-area owl">
                        ...
                        <?php
                         ...
                         ?>
                             <?php if ( has_post_thumbnail() ) {
                               ...
                               <p><?php $excerpt = get_the_excerpt(); echo custom_echo($excerpt,130); ?></p>
       ...
       <div class="pc mtop5 mbottom"><?php the_field('page_content'); ?></div>
 </div>
