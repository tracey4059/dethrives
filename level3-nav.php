<?php
/*
Template Name: Level 3 with Nav
*/
get_header();
?>
<style>
...
.ctf-tweet-actions a{color:#<?php the_field('page_color'); ?>}
</style>
...
<div class="row">
             ...
             <div class="large-4 medium-4 small-12 columns">
                 ...
                 <div class="temp2-menu2">
                      ...
                      <ul class="cardlinks-temp2">
                         <li class="current-page"><a href="<?php echo get_page_link(); ?>">Overview</a></li>
    ...
    <?php if (is_page('509')): ?>
      <div class="social-feed large-12 medium-12 small-12 columns">
        <div class="row">
          <div class="af-facebook large-6 medium-6 small-12 columns">
            <div class="row fb-header">
              <div class="large-6 medium-6 small-6 columns">
                <h1 class="soc-title">Facebook</h1>
              </div>
              <div class="large-6 medium-6 small-6 columns">
                <div class="af-icon-con">
                  <i class="fa fa-facebook-square af-icon" aria-hidden="true"></i>
                </div>
              </div>
            </div>
            <?php echo do_shortcode( '[custom-facebook-feed num=3 postbgcolor=fff textlength=185 showauthor=false]' ); ?>
            <div class="s-link mbottom" style="background-color: #<?php the_field('page_color'); ?> !important;">
              <a href="https://www.facebook.com/DEthrives/" target="_blank">View More on Our Facebook Page <i class="fa fa-angle-right" aria-hidden="true"></i></a>
            </div>
          </div>
          <div class="af-twitter large-6 medium-6 small-12 columns">
            <div class="row fb-header">
              <div class="large-6 medium-6 small-6 columns">
                <h1 class="soc-title">Twitter</h1>
              </div>
              <div class="large-6 medium-6 small-6 columns">
                <div class="af-icon-con">
                  <i class="fa fa-twitter af-icon" aria-hidden="true"></i>
                </div>
              </div>
            </div>
            <?php echo do_shortcode( '[custom-twitter-feeds num=3 showheader=false twitterlinktext="View Tweet" exclude="retweeter,actions,author,avatar"]' ); ?>
            <div class="s-link mbottom" style="background-color: #<?php the_field('page_color'); ?> !important;">
              <a href="https://twitter.com/DEThrives" target="_blank">View More on Our Twitter Page <i class="fa fa-angle-right" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </div>
